...
duration: "5 hours"
distance: "9.5 km"
tags: [cvrsnica, viewpoint, spring, system-audit]
featured_image: /assets/images/trips/zlijeb/zlijeb-4.jpg
gallery:
  - /assets/images/trips/zlijeb/zlijeb-1.jpg
  - /assets/images/trips/zlijeb/zlijeb-2.jpg
  - /assets/images/trips/zlijeb/zlijeb-3.jpg
  - /assets/images/trips/zlijeb/zlijeb-4.jpg
  - /assets/images/trips/zlijeb/zlijeb-5.jpg
  - /assets/images/trips/zlijeb/zlijeb-bottom.jpg
  - /assets/images/trips/zlijeb/zlijeb-fico.jpg
  - /assets/images/trips/zlijeb/zlijeb-oz.jpg
...
Before a single step uphill, the trailhead had already introduced two characters. The first: a van parked with its rear doors open, driver inside, deep in the kind of sleep that belongs to people who spend their days waiting. We woke him by accident, without apology on either side.

The second was less expected. Just a hundred meters up a track barely passable by anything with four wheels, a local gentleman and his Zastava 750 (Fićo)had arrived at a point that would humble most modern 4x4s.
...
Higher up, the trees thinned and the rock took over, bare, open, exposed to whatever the sky was doing. Then, high enough that the forest had given up, something hung from a branch: a discarded T-shirt with the inscription: **"Toto, I don't think we're in Kansas anymore."**
...
> *(And what happens in the end, well you know... passengers for Sydney, come on, exit gate such-and-such...)*
>
...
Four of us stood there nodding at the profundity of it all, each quietly reaching for a phone.

## III. The viewpoint and the metric displacement

Reaching the viewpoint opened up a sweeping view over a valley far below. Near the summit, there is a mountain hut where one can stay, but once again, we bypassed this logistical option.
...
Seeing a city signature in this vertical wilderness felt like a leakage between two worlds that were never supposed to touch.

## IV. The descent, and what came back with us

On the descent, we passed the van driver again, now fully awake and talkative. A former musician, now helping his son run a transport operation. Before we reached the car, he had answered every question we'd been saving up.
...
On the way home, one thought stayed. The Wizard doesn't hold you with chains, he holds you with announcements. Gate changes, departures, redirections, always one more thing to wait for. 

But somewhere back at the trailhead, a man in long johns had already opted out of that arrangement entirely. No gate, no schedule, no performance. Just his mountain, his car, and his own timing.
